...
class Embedded {
  ...
  constructor ({
    ...
    this.ui = components.AppController.create(this.state, {
      ...
      app: { version:`${_package_json__WEBPACK_IMPORTED_MODULE_1__["version"]}`, buildBranch: "dev", buildNumber: "20200626447", buildName: "dev.20200626447", name: _package_json__WEBPACK_IMPORTED_MODULE_1__["description"] },
