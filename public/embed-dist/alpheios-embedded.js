...
class Embedded {
  ...
  constructor ({
    ...
    this.ui = components.UIController.create(this.state, {
      ...
      app: { version:`${_package_json__WEBPACK_IMPORTED_MODULE_1__["version"]}`, buildBranch: "dev", buildNumber: "20200604445", buildName: "dev.20200604445", name: _package_json__WEBPACK_IMPORTED_MODULE_1__["description"] },
